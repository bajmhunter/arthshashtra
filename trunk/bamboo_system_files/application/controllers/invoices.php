...
class Invoices extends MY_Controller {
	...
	function email($id)
	{
		...
		if (pdf_create($html, "$invoice_number", FALSE))
		{
		...
		$subject = $this->lang->line('invoice_invoice')." $invoice_number : ".$data['companyInfo']->company_name;
		...
		$this->email->attach("./invoices_temp/invoice_$invoice_number.pdf");
