...
?>
	...
	?>
		...
		<p>
			<label><?php echo $this->lang->line('invoice_number');?> <input type="text" name="invoice_number" id="invoice_number" maxlength="12" value="<?php echo ($this->validation->invoice_number) ? ($this->validation->invoice_number) : ($invoice_number);?>" /></label> <?php echo $this->validation->invoice_number_error;?><?php echo (isset($invoice_number_error))?'<span id="invoice_number_error" class="error">' . $this->lang->line('invoice_not_unique'). '</span>':'';?> 
