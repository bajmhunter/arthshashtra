...
<div class="work_description download">
	<p><a id="bamboodownload" href="http://bambooinvoice.org/img/bambooinvoice_088.zip">Download Bamboo 0.8.8</a> <strong>December 22, 2008</strong> (view <?php echo anchor ('changelog', 'changelog') . ' and ' . anchor('credits', 'credits');?>) </p>
</div>
...
<ul>
	...
	<li><?php echo $this->lang->line('bambooinvoice_logo');?> is internationalized. Currently it is available in English, French, German, Dutch, Romanian, Spanish, Portuguese, Bulgarian, Swedish, and Italian with new languages being added all the time.</li>
